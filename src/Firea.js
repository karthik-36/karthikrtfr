...
export default function Model({ ...props }) {
  const group = useRef()
  const { nodes, materials, animations } = useGLTF('/firea.glb')
  ...
  return (
    <group scale ={[1.7,1.7,1.7]}  rotation = {[0,0.75,0]} position = {[0.35,0,0]} ref={group} {...props} dispose={null}>
      <group>
